...
TOOLS = [
    ...
    {"type": "function", "function": {"name": "find_available_projects", "description": "List all open (unfilled) projects with their roles, bill rates, and deadlines. Returns project_id and role_id needed for matching.", "parameters": {"type": "object", "properties": {}}}},
    ...
    {"type": "function", "function": {"name": "interview_candidate", "description": "Perform a technical interview with a candidate to reveal skills and salary. Costs $500.", "parameters": {"type": "object", "properties": {"candidate_id": {"type": "string"}}, "required": ["candidate_id"]}}},
    {"type": "function", "function": {"name": "hire_candidate", "description": "Hire an interviewed candidate to your bench. Costs $2000 onboarding.", "parameters": {"type": "object", "properties": {"candidate_id": {"type": "string"}}, "required": ["candidate_id"]}}},
    ...
    {"type": "function", "function": {"name": "match_candidate_to_project", "description": "Place a hired candidate onto a specific project role. Requires project_id and role_id from find_available_projects.", "parameters": {"type": "object", "properties": {"candidate_id": {"type": "string"}, "project_id": {"type": "string"}, "role_id": {"type": "string"}}, "required": ["candidate_id", "project_id", "role_id"]}}},
    {"type": "function", "function": {"name": "confirm_project", "description": "Confirm a project to lock it in for your agency.", "parameters": {"type": "object", "properties": {"project_id": {"type": "string"}}, "required": ["project_id"]}}},
    {"type": "function", "function": {"name": "pass_on_project", "description": "Decline a project you cannot fill. Avoids expiry penalty with no satisfaction hit.", "parameters": {"type": "object", "properties": {"project_id": {"type": "string"}}, "required": ["project_id"]}}},
    {"type": "function", "function": {"name": "let_go_candidate", "description": "Release a hired candidate from your bench to stop salary burn.", "parameters": {"type": "object", "properties": {"candidate_id": {"type": "string"}}, "required": ["candidate_id"]}}},
    {"type": "function", "function": {"name": "request_project_extension", "description": "Request a deadline extension for a project (1-3 weeks). Slightly hurts client satisfaction.", "parameters": {"type": "object", "properties": {"project_id": {"type": "string"}}, "required": ["project_id"]}}},
    ...
    {"type": "function", "function": {"name": "advance_week", "description": "Finish all actions for the current week and advance simulation time. Triggers billing, bench costs, and deadline ticks.", "parameters": {"type": "object", "properties": {}}}},
]
